...
// GET /api/v1/admin/users/:id - Get single user details (admin only)
router.get('/users/:id', authenticateToken, isAdmin, async (req, res, next) => {
    try {
...
router.put('/users/:id/role', authenticateToken, isAdmin, roleUpdateValidation, async (req, res, next) => {
    try {
...
// PUT /api/v1/admin/users/:id/team - Assign team members to manager (admin only)
router.put('/users/:id/team', authenticateToken, isAdmin, async (req, res, next) => {
    try {
...
router.get('/tasks', authenticateToken, isAdmin, async (req, res, next) => {
    try {
        const {
            page = 1,
            limit = 10,
...
router.delete('/tasks/:id', authenticateToken, isAdmin, async (req, res, next) => {
    try {
